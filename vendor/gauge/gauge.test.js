...
(function() {
  ...
  BaseGauge = (function(superClass) {
    ...
    BaseGauge.prototype.configDisplayScale = function() {
      ...
      console.log("displayScale = " + this.displayScale);
      return this;
    };
  ...
  GaugePointer = (function(superClass) {
    ...
    GaugePointer.prototype.setOptions = function(options) {
      ...
      this.length = 2 * this.gauge.radius * this.options.length;
  ...
  Gauge = (function(superClass) {
    ...
    Gauge.prototype.renderStaticLabels = function(staticLabels, w, h) {
      var j, len, ref, rotationAngle, value;
      this.ctx.save();
      this.ctx.translate(w, h);

      // Scaling the font for high DPI
      var font = staticLabels.font || "10px Times";
      var re = /\d+\.?\d?/;
      var match = font.match(re)[0];
      var rest = font.slice(match.length);
      var fontsize = parseFloat(match) * this.displayScale;
      ...
      for (j = 0, len = ref.length; j < len; j++) {
        ...
        this.ctx.fillText(formatNumber(value), 0, -this.radius - this.lineWidth / 2);
        this.ctx.rotate(-rotationAngle);
      }
    ...
    Gauge.prototype.render = function() {
      var displayedAngle, fillStyle, gauge, h, j, k, len, len1, ref, ref1, w, zone;
      ...
      if (this.options.staticLabels) {
        this.renderStaticLabels(this.options.staticLabels, w, h);
      }
      if (this.options.staticZones) {
        ...
        for (j = 0, len = ref.length; j < len; j++) {
          ...
          this.ctx.beginPath();
          this.ctx.arc(0, 0, this.radius, this.getAngle(zone.min), this.getAngle(zone.max), false);
          this.ctx.stroke();
        }
        this.ctx.restore();
      } else {
