						...
						<div class="w-100">
							...
							<?php
								...
								if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['id'])) {
									...
									$sql = "UPDATE gama SET gama = '$gama' WHERE idi = $id";

									// Executa a query e verifica se foi bem sucedida
									if (mysqli_query($link, $sql)) {
										// regista o log da edição do serviço
										$acao = "Edição da gama: ID $id";
										registar_log($link, $acao);
										$showForm = false;
										echo "registo atualizado com sucesso!";
										echo '<script>window.location.href = "listar_gama.php";</script>';
								...
								if ($showForm && isset($_GET['id'])) {
									...
									$query = "SELECT * FROM gama WHERE idi = $id";
									...
									<form method="post" action="editar_gama.php" id="editForm">
										<section class="card">
											<div class="card-body">
												...
												<div class="form-group row pb-4">
													...
													<div class="col-lg-6">
														<input type="text" name="gama" value="<?php echo $row['gama']; ?>"
															class="form-control">
													</div>
												</div>
											</div>
