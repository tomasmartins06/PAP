				...
				<header class="page-header">
					...
					<div class="right-wrapper text-end">
						<ol class="breadcrumbs">
							...
							<li><span>Inserir Nova Estado</span></li>
							<li><span>Editar Estado</span></li>
						...
						<div class="w-100">
							...
							<?php
								...
								if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['id'])) {
									...
									$sql = "UPDATE estado SET estado = '$estado' WHERE idt = $id";

									// Executa a query e verifica se foi bem sucedida
									if (mysqli_query($link, $sql)) {
										// regista o log da edição do serviço
										$acao = "Edição do estado: ID $id";
										registar_log($link, $acao);
										$showForm = false;
										echo "registo atualizado com sucesso!";
										echo '<script>window.location.href = "listar_estado.php";</script>';
								...
								if ($showForm && isset($_GET['id'])) {
									...
									$query = "SELECT * FROM estado WHERE idt = $id";
									...
									<form method="post" action="editar_estado.php" id="editForm">
										<section class="card">
											<div class="card-body">
