                        ...
                        <div class="datatable-header">
                            <div class="row align-items-center mb-3">
                                ...
                                <?php
                                    ...
                                    if(isset($_POST['filter-by']) && $_POST['filter-by']!= "") {
                                        $filtro = $_POST['filter-by'];
                                        $query.= " WHERE estado_electro = '$filtro'";
                                    }
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="filter-by" class="form-control select-style-1 filter-by"
                                            ...
                                            <?php
                                                ...
                                                $qry = "SELECT DISTINCT estado_electro FROM eletrodomesticos";
                                                ...
                                                while ($row_state = mysqli_fetch_assoc($result_states)) {
                                                    $estado = htmlspecialchars($row_state['estado_electro']);
                                ...
                                <table class="table table-bordered table-striped mb-0" id="datatable-editable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row['estado_electro'] ?></td>
