...
<div class="nano">
                ...
                <header class="page-header">
                    ...
                    <div class="right-wrapper text-end">
                        <ol class="breadcrumbs">
                            <li><a href="index.php"><i class="bx bx-home-alt"></i></a></li>
                                        ...
                                        <div class="w-100">
                                            <div class="bg-light">
                                                <div class="form-container">
                                                    ...
                                                    <button id="toggleCamera" class="btn btn-primary mt-3">Toggle
                                                        Camera</button>
                                                </div>
                                            </div>
                                        </div>
    ...
    <aside id="sidebar-right" class="sidebar-right">
        <!-- Conteúdo do sidebar-right omitido para brevidade -->
    </aside>
    </section>
    <section role="main" class="content-body">
    ...
    <script>
        ...
        document.getElementById('toggleCamera').addEventListener('click', () => {
            const cameraSelect = document.getElementById('cameraSelect');
            const optionIndex = cameraSelect.selectedIndex === cameraSelect.options.length - 1 ? 0 :
                cameraSelect.selectedIndex + 1;
            cameraSelect.selectedIndex = optionIndex;
            currentDeviceId = cameraSelect.value;
            startCamera();
        });
